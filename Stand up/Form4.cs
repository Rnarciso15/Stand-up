...
namespace Stand_up
{
    public partial class Form4 : Form
    {
                                            ...
                                            if (guna2TextBox7.Text != "")
                                            {
                                                ...
                                                if (guna2TextBox8.Text.Length == 9)
                                                {
                                                    ...
                                                    if (guna2ComboBox8.SelectedIndex != -1)
                                                    {
                                                        ...
                                                        {
                                                            DataTable emailverification = ApiService.Func.queryFunc_emailIgual(guna2TextBox2.Text, n_func);
                                                            if (emailverification.Rows.Count < 1)
                                                            {
                                                                DataTable telefoneverification = ApiService.Func.queryFunc_telefoneIgual(guna2TextBox5.Text, n_func);
                                                                if (telefoneverification.Rows.Count < 1)
                                                                {
                                                                    DataTable Nibverification = ApiService.Func.queryFunc_NibIgual(guna2TextBox6.Text, n_func) ;
                                                                    if (Nibverification.Rows.Count < 1)
                                                                    {
                                                                        DataTable nifverification = ApiService.Func.queryFunc_NifIgual(guna2TextBox8.Text, n_func) ;
                                                                        if (nifverification.Rows.Count < 1)
                                                                        {
                                                                            ...
                                                                            {
                                                                                int x = ApiService.Func.insertFunc(guna2TextBox9.Text, Hash(senha), true, guna2TextBox4.Text, guna2TextBox2.Text, guna2TextBox5.Text, guna2TextBox6.Text, imgToByteArray(guna2PictureBox2.Image), guna2TextBox8.Text, guna2TextBox7.Text, guna2ComboBox8.SelectedItem.ToString(), false);
                                                                                guna2DataGridView1.DataSource = ApiService.Func.Load();

                                                                                string id_novoFunc = ApiService.Func.queryFunc_get_id(guna2TextBox8.Text).Rows[0]["n_func"].ToString();
                                                                                try
                                                                                {
                                                    ...
                                                    if (guna2ComboBox8.SelectedIndex != -1)
                                                    {
                                                        ...
                                                        if (IsValidEmail(email))
                                                        {
                                                            ...
                                                            if(email_eeditado == false && telefone_eeditado == false && nib_eeditado ==false && nif_eeditado == false)
                                                            {
                                                                ...
                                                                if (dr == DialogResult.Yes)
                                                                {
                                                                    int x = ApiService.Func.updateFunc(Convert.ToInt32(guna2TextBox10.Text), guna2TextBox9.Text, Ativo, guna2TextBox4.Text, guna2TextBox2.Text, guna2TextBox5.Text, guna2TextBox6.Text, imgToByteArray(guna2PictureBox2.Image), guna2TextBox8.Text, guna2TextBox7.Text, guna2ComboBox8.Text);
                                                                    guna2DataGridView1.DataSource = ApiService.Func.Load();
                                                                }
                                                            }
                                            ...
                                            if (guna2TextBox7.Text != "")
                                            {
                                                ...
                                                if (guna2TextBox8.Text.Length == 9)
                                                {
                                                    ...
                                                    if (guna2ComboBox8.SelectedIndex != -1)
                                                    {
                                                        ...
                                                        if (IsValidEmail(email))
                                                        {
                                                            DataTable emailverification = ApiService.Clientes.queryFunc_emailIgual(guna2TextBox2.Text, n_cliente);
                                                            if (emailverification.Rows.Count < 1)
                                                            {
                                                                DataTable telefoneverification = ApiService.Clientes.queryFunc_telefoneIgual(guna2TextBox5.Text, n_cliente);
                                                                if (telefoneverification.Rows.Count < 1)
                                                                {
                                                                    DataTable Nibverification = ApiService.Clientes.queryFunc_NibIgual(guna2TextBox6.Text, n_cliente);
                                                                    if (Nibverification.Rows.Count < 1)
                                                                    {
                                                                        DataTable nifverification = ApiService.Clientes.queryFunc_NifIgual(guna2TextBox8.Text, n_cliente);
                                                                        if (nifverification.Rows.Count < 1)
                                                                        {
                                                                            ...
                                                                            if (dr == DialogResult.Yes)
                                                                            {
                                                                                int x = ApiService.Clientes.insertCliente(guna2TextBox5.Text, guna2TextBox9.Text, true, guna2TextBox4.Text, guna2TextBox2.Text, guna2TextBox6.Text, imgToByteArray(guna2PictureBox2.Image), guna2TextBox8.Text, guna2TextBox7.Text, guna2ComboBox8.Text, Hash("1234"));
                                                                                guna2DataGridView1.DataSource = ApiService.Clientes.Load();
                                                                            }
                                                                        }
                                                                        else
                                                    ...
                                                    if (guna2ComboBox8.SelectedIndex != -1)
                                                    {
                                                        ...
                                                        if (IsValidEmail(email))
                                                        {
                                                            ...
                                                            if (email_eeditado == false && telefone_eeditado == false && nib_eeditado == false && nif_eeditado == false)
                                                            {
                                                                ...
                                                                if (dr == DialogResult.Yes)
                                                                {
                                                                    int x = ApiService.Clientes.updateCliente(n_cliente, guna2TextBox9.Text, Ativo, guna2TextBox4.Text, guna2TextBox2.Text, guna2TextBox5.Text, guna2TextBox6.Text, imgToByteArray(guna2PictureBox2.Image), guna2TextBox8.Text, guna2TextBox7.Text, guna2ComboBox8.Text);
                                                                    guna2DataGridView1.DataSource = ApiService.Clientes.Load();
                                                                }
                                                            }
        ...
        private void guna2Button2_Click(object sender, EventArgs e)
        {
            ...
            {
                if (Hash(guna2TextBox12.Text) == ApiService.Func.queryFunc_get_senha(Form5.n_func).Rows[0]["senha"].ToString())
                {
                    DialogResult dr = MessageBox.Show("Tem a certexa que quer alterar a senha?", "", MessageBoxButtons.YesNo);
                    if (dr == DialogResult.Yes)
                    {
                        int x = ApiService.Func.senhaFunc(Hash(guna2TextBox1.Text), Form5.n_func, Hash(guna2TextBox12.Text));
                        guna2TextBox1.Clear();
                        guna2TextBox12.Clear();
        ...
        private void guna2Button6_Click(object sender, EventArgs e)
        {
            ...
            if (Form1.flagFunc == true)
            {
                ...
                if (dr == DialogResult.Yes)
                {
                    ApiService.Func.senhaFunc1(Hash(guna2TextBox11.Text), Convert.ToInt32(guna2TextBox10.Text));
                    guna2TextBox11.Clear();
                    guna2TextBox10.Clear();
            ...
            else
            {
                ...
                if (dr == DialogResult.Yes)
                {
                    ApiService.Clientes.senhaCliente(Hash(guna2TextBox11.Text), Convert.ToInt32(guna2TextBox10.Text));
                    guna2TextBox11.Clear();
                    guna2TextBox10.Clear();
