    ...
    public partial class Marcacao_test : Form
    {
     ...
     Image imageM;
        ...
        void carregar_car_PARA_LISTVIEW123()
        {
            ...
            DataTable dr = ApiService.veiculos.queryLoad_veiculoMatricula(false,guna2TextBox3.Text);
        ...
        void carregar_func_PARA_LISTVIEW1234()
        {
            ...
            DataTable dt = ApiService.Func.queryLoad_Func1234(guna2TextBox4.Text,true);
        ...
        void carregar_func_PARA_LISTVIEW()
        {
            ...
            DataTable dt = ApiService.Func.queryLoad_Func_ativo(true);
        ...
        void carregar_cliente_PARA_LISTVIEW1234()
        {
            ...
            DataTable dt = ApiService.Clientes.queryLoad_cliente1234(guna2TextBox5.Text,true);
        ...
        void Ativar_marcacao()
        {
           ...
           if(dia <= 9 && mes <= 9)
            ...
            if (DateTime.TryParseExact(dataString, "dd/MM/yyyy", null, System.Globalization.DateTimeStyles.None, out data))
            {
                ...
                guna2DataGridView1.DataSource = ApiService.testDrive.queryLoad_Test(data_sem_hora);
...
verificar_dia();
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            DataTable DH = ApiService.testDrive.procurarFuncOcupado(Insertdata,Convert.ToInt32(id_func));
                            if (DH.Rows.Count <= 0)
                            {
                               DataTable DH1 = ApiService.testDrive.procurarClienteOcupado(Insertdata, Convert.ToInt32(id_cliente));
                                if (DH1.Rows.Count <= 0)
                                {
                                   DataTable DH2 = ApiService.testDrive.procurarCarroOcupado(Insertdata, matricula);
                                    if (DH2.Rows.Count <= 0)
                                    {
                                        int x = ApiService.testDrive.insertTest(data_sem_hora, Insertdata, Convert.ToInt32(id_func), nomeFunc, Convert.ToInt32(id_cliente), nomeCliente, marca, modelo, matricula, imgToByteArray(imageM));
                                        guna2DataGridView1.DataSource = ApiService.testDrive.queryLoad_Test(data_sem_hora);
        ...
        private void guna2Button33_Click(object sender, EventArgs e)
        {
            ...
            {
                ApiService.testDrive.EleminarTest(id_test);
                Ativar_marcacao();
            }
            }
            catch
