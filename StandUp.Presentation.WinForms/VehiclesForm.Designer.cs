...
partial class VehiclesForm
{
    ...
    private void InitializeComponent()
    {
        ...
        txtSearchModel.Location = new Point(158, 14); txtSearchModel.Size = new Size(140, 23); txtSearchModel.PlaceholderText = "Modelo";
        chkSoldFilter.Location = new Point(304, 14); chkSoldFilter.Size = new Size(90, 23); chkSoldFilter.Text = "Vendidos";
        btnSearch.Location = new Point(400, 13); btnSearch.Size = new Size(75, 23); btnSearch.Text = "Pesquisar"; btnSearch.Click += btnSearch_Click;
        btnRefresh.Location = new Point(481, 13); btnRefresh.Size = new Size(75, 23); btnRefresh.Text = "Atualizar"; btnRefresh.Click += btnRefresh_Click;
        txtPlate.Location = new Point(12, 305); txtPlate.Size = new Size(100, 23); txtPlate.PlaceholderText = "Matrícula";
        cbBrand.Location = new Point(118, 305); cbBrand.Size = new Size(110, 23); cbBrand.DropDownStyle = ComboBoxStyle.DropDownList;
        ...
        Controls.AddRange([gridVehicles, txtSearchPlate, txtSearchModel, chkSoldFilter, btnSearch, btnRefresh, txtPlate, cbBrand, txtModel, txtFuel, txtKilometers, txtPrice, chkMotorcycle, btnCreate, txtPlateStatus, chkSetSold, btnSetSold]);
